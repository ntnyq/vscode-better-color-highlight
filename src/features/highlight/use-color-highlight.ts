...
import { groupColorMatchesWithinLimits } from '../../engine/detection/color-match'
import {
  getStrategies,
...
function createHighlightRunSignature(
  ...
  return JSON.stringify({
    ...
    tailwindStylesheetPaths: highlightConfig.tailwindStylesheetPaths,
    ...
    resolveDesignTokensAcrossFiles:
      highlightConfig.resolveDesignTokensAcrossFiles,
