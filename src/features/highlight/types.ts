import type { CancellationSignal } from '../../engine/detection/types'
import type { NestedScopedConfigs } from '../../meta'

/** Disposable value produced by a reactive extension composable. */
export type Disposable<T> = T & {
  dispose: () => void
}

/** Supported decoration marker styles. */
